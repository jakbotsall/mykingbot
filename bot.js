...
client.on('ready', function(){
    var ms = 10000 ;
    var setGame = ['In 67 Server','*help | *invite','In 67 Server','*help | *invite','In 67 Server'];
    var i = -1;
    var j = 0;
...
⤠ *quran 1  :   القران الكريم كامل بصوت الشيخ عبدالباسط عبدالصمد 
⤠ *quran 2  :   سورة البقرة كاملة - القارئ الحاج ميثم التمار 
⤠ *quran 3  :   القرآن الكريم كامل بصوت الشيخ عبد الرحمن السديس وسعود الشريم 
⤠ *quran 4  :   القرآن الكريم كامل بصوت الشيخ المعيقلي
⤠ *stop     : لـ أيقاف تشغيل البوت 
`)
