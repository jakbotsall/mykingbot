...
client.user.setGame(`In 32 Server | *invite`,"http://twitch.tv/S-F")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
:musical_note:   *unpause 『لموآصلة الإغنية بعد إيقآفهآ مؤقتا』               
					 
:musical_note:   *vol 『لتغيير درجة الصوت 100 - 0』                   

:musical_note:   *join 『عشان تدخل البوت لرومك الصوتي』   
