...
⤠${prefix}skip ⥨ لتجاوز الاغنية الحالية
⤠${prefix}pause ⥨ لايقاف الاغنية
⤠${prefix}resume ⥨ لامواصلة الاغنية
⤠${prefix}vol ⥨ لتغيير درجة الصوت 100 - 0
⤠${prefix}stop ⥨ لاخراج البوت من رومك
⤠${prefix}join ⥨ لادخال البوت الى رومك الصوتي
